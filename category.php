                    ...
                    <div class="card position-relative mx-auto bg-body-secondary border-primary">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <div class="d-flex">
                                ...
                                <div>
                                    <a href="action/updateCategoryStocks.php" class="btn btn-outline-primary"
                        ...
                        echo "<td>
                                    <div class='dropdown' >
                                        ...
                                        <ul class='dropdown-menu px-2 border-info'>
                                            <li><button type='button' class='btn btn-outline-info w-100 mb-1 text-start' onclick='openEditModal({$category['categoryID']})'>
                                            <svg class='bi pe-none' width='24' height='24'>
                                                <use xlink:href='#edit' />
                                            </svg>&nbsp;
                                            Edit Category
                                            </button></li>
                                            <li><a class='btn btn-outline-info w-100' onclick='return confirmDelete();' href='action/deleteCategory.php?id={$category['categoryID']}'>
                                            <svg class='bi pe-none' width='24' height='24'>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="action/addCategory.php" method="post" id="addCategoryForm">
                                        ...
                                        <div class="form-floating">
                                            <input type="text" name="addCategoryName" id="addCategoryName"
                                                class="form-control <?php echo (!empty($category_err)) ? 'is-invalid' : ''; ?>">
                                            <label for="floatingInput">Category Name</label>
                                            <span class="invalid-feedback"
                                                id="categoryAddError"><?php echo $category_err; ?></span>
                                        </div>
                        ...
                        <div class="modal-body">
                            <div class="card border-success">
                                <div class="card-body">
                                    ...
                                    <form action="action/editCategory.php" method="post" id="editCategoryForm">
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="floatingInput">Category Name</label>
                                            <span class="invalid-feedback"
                                                id="categoryEditError"><?php echo $category_err; ?></span>
                                        </div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                data-bs-dismiss="modal">Close</button>
                                            <button type="button" class="btn btn-primary" onclick="editCategory()">Edit
                                                Category</button>
                                        </div>
                                    </form>
                                </div>
