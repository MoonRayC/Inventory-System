...
<body>
    ...
    <div id="permissionMessage" class="alert alert-danger alert-dismissible" role="alert"
        style='position: fixed; top: 20px; right: 20px; z-index: 9999; width:50rem;' hidden>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col">
                    <div class="card position-relative mx-auto bg-body-secondary border-primary">
                        <div class="d-flex justify-content-between align-items-center p-3">
                            ...
                            <div class="d-flex">
                                <div class="me-3">
                                    <a href="order.php" class="btn btn-outline-primary" data-bs-toggle="popover"
                ...
                if($order){
                    foreach ($order as $order) {
                        ...
                        }else if ($order['paymentStatus'] === "Advance Payment"){
                            $status = "Advance Payment";
                            $statusClass = "btn-primary";
                        }else if ($order['paymentStatus'] === "Partial Payment"){
                            $status = "Partial Payment";
                            $statusClass = "btn-warning";
                        }else if ($order['paymentStatus'] === "No Payment"){
                            $status = "No Payment";
                        ...
                        echo "<td>{$order['customerAddress']}</td>";
                        ...
                        echo "<td>
                                <div class='dropdown' style='min-width: 200px;'>
                                    ...
                                    <ul class='dropdown-menu px-2 border-info'> 
                                        <li><button type='button' class='btn btn-outline-info w-100 mb-1' onclick='openViewOrder({$order['orderID']})'>
                                        <svg class='bi pe-none' width='24' height='24'>
                                            <use xlink:href='#eye' />
                                        </svg>&nbsp; 
                                        View Details
                                    ...
                                    <form action="action/editOrder.php" method="post">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="text" name="paidAmount" id="paidAmount" class="form-control"
                                                autocomplete="off" onkeyup="paidAmount()" value="0">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col text-end">
                                    ...
                                    <p>rdcj.shop</p>
                                    <p>09518184733</p>
                                    <a href="mailto:rdcj_ims@yahoo.com">rdcj_ims@yahoo.com</a>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-8 text-start">
                                    <div class="d-flex">
                                        ...
                                        <span class="ms-2" id="customerName"></span>
                                    </div>
                                    <div class="d-flex">
                                        <p>Customer Number: </p>
                                        <span class="ps-1"></span>
                                        <span class="ms-2" id="customerNumber"></span>
                                    </div>
                                </div>
                                <div class="col text-start">
                                    <div class="d-flex">
                                ...
                                <div class="row">
                                    ...
                                    <hr>
                                    <div class="mx-auto text-center">
                                        <img src="assets/imgs/Slogo.png" alt="company logo"
    ...
    <script src="scripts/validateOrder.js"></script>
